...
namespace OrderingOperators
{
    internal class Program
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static IOrderedEnumerable<Product> OrderProducts()
        {
        ...
        /// <summary>
        /// Sort a list of customers, first by City, and then by Address.
        /// </summary>
        /// <returns></returns>
        public static IOrderedEnumerable<Customer> OrderCustomer()
        {
            return from c in customers
                   orderby c.City, c.Address //descending
                   select c;
        }
        ...
        private static void Main(string[] args)
        {
            ...
            /// Order customers by city and address
            Console.WriteLine("\nCustomerID, CompanyName, Address, City, Region, PostalCode, Country, Phone");
            foreach (var customer in OrderCustomer())
            {
                Console.WriteLine($"{customer.CustomerID}, {customer.CompanyName}, {customer.Address}, {customer.City}, {customer.Region}, {customer.PostalCode}, {customer.Country}, {customer.Phone}");
            }
        }
    }
}
